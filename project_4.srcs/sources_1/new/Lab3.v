...
module InstructionMemory(pc, instOut);
    ...
    initial begin
        //assign the instruction values in memory here (words 25, 26, 27, 28,29)
       memory[25] = {6'b000000,5'd1,5'd2,5'd3,5'd0,6'b100000}; //add $3,$1,$2 rd rs rt
        memory[26] = {6'b000000,5'd9,5'd3,5'd4,5'd0,6'b100010}; //sub $4,$9,$3
        memory[27] = {6'b000000,5'd3,5'd9,5'd5,5'd0,6'b100101}; //or $5,$3,$9
        memory[28] = {6'b000000,5'd3,5'd9,5'd6,5'd0,6'b100110}; //xor $6,$3,$9
        memory[29] = {6'b000000,5'd3,5'd9,5'd7,5'd0,6'b100100}; //and $7,$3,$9
    end
    always @(*) begin
...
module Datapath(clk, pc,qa,qb, dinstOut, ewreg, em2reg , ewmem, ealuc, ealuimm, edestReg, eqa, eqb, eimm32,
